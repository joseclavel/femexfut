...
let DatasvcService = class DatasvcService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    getClientes(buscarPor) {
...
let OrdenesComponent = class OrdenesComponent {
    ...
    busquedaInteligente() {
        let result = this.orders[this.orders.findIndex(x => x.Cliente !== null && x.Cliente.razonSocial === 'AMERICA')];
        console.log(result);
    }
